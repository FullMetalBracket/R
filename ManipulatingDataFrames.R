...
#dataframes can be accessed as either position / rules / names
print(shopping_data)

shopping_data[c(1:3), 1] # get first three products
shopping_data[, 3] # get third column
shopping_data[1, 3]
...
shopping_data[, 1]
shopping_data[[1]] #produces vector
shopping_data[1] #produces data frame
